...
from cp_review.provenance import build_artifact_inventory, sha256_file, write_provenance_file
...
def test_sha256_file_returns_none_for_missing_files(tmp_path: Path):
